      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.poster.index') }}">Poster list</a></li>
            
            <li class="breadcrumb-item active">Update Poster</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="col-md-8">
      ...
      <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Update Poster</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" action="{{ route('admin.poster.update',$blog->id) }}" method="post" enctype="multipart/form-data">
          @method('PUT')
          @csrf
          <div class="card-body">
